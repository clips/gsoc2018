...
## Instructions to setup
 ...
 6.  Download the [Plasticity AI's](https://github.com/plasticityai/magnitude) magnitude format of word by clicking [here](http://magnitude.plasticity.ai/glove+approx/glove.6B.100d.magnitude). 
